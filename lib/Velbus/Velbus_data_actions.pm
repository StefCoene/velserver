...
$global{Cons}{ActionType}{Blind}{Action}{Get}{Command}  = "EC" ;
...
$global{Cons}{ActionType}{Button}{Action}{Get}{Command}  = "00" ;
...
$global{Cons}{ActionType}{ButtonLong}{Action}{Get}{Command}  = "00" ;
...
$global{Cons}{ActionType}{Counter}{Action}{Get}{Command}  =  "BE" ;
...
$global{Cons}{ActionType}{Counter}{Action}{GetCurrent}{Command}  =  "BE" ;
...
$global{Cons}{ActionType}{Counter}{Action}{GetDivider}{Command}  =  "BE" ;
...
$global{Cons}{ActionType}{Counter}{Action}{GetRaw}{Command}  =  "BE" ;
...
$global{Cons}{ActionType}{Dimmer}{Action}{Get}{Command} = "0F,B8" ; # B8 is for VMB4DC (12): 0/1 to 10V dimmer controller module and VMBDMI-R (15): Velbus dimmer for resistive or inductive load
...
$global{Cons}{ActionType}{Relay}{Action}{Get}{Command} = "FB" ;
...
$global{Cons}{ActionType}{Sensor}{Action}{Get}{Command} = "00" ;
...
$global{Cons}{ActionType}{Temperature}{Action}{Get}{Command} = "E6" ;
...
$global{Cons}{ActionType}{TemperatureCoHeMode}{Action}{Get}{Command} = "DF,E0" ;
...
$global{Cons}{ActionType}{TemperatureMode}{Action}{Get}{Command} = "EA" ;
...
$global{Cons}{ActionType}{TemperatureTarget}{Action}{Get}{Command} = "EA" ;
